...
import { executeOpenclawAdapter } from "../../../src/adapters/openclaw/execute.js";
import { openclawSessionCodec } from "../../../src/adapters/openclaw/codec.js";
import { testOpenclawEnvironment } from "../../../src/adapters/openclaw/test.js";
...
describe("executeOpenclawAdapter", () => {
  it("handles successful execution", async () => {
    const result = await executeOpenclawAdapter(makeCtx({
